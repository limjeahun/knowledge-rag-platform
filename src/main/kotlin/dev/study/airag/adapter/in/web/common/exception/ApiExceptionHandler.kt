...
class ApiExceptionHandler {
    ...
    /** 요청한 파생 그래프 개체가 없음을 `404 Not Found`로 변환한다. */
    @ExceptionHandler(KnowledgeGraphEntityNotFoundException::class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    fun knowledgeGraphEntityNotFound(exception: KnowledgeGraphEntityNotFoundException) =
        ApiErrorResponse(exception.message ?: "지식 그래프 개체를 찾을 수 없습니다.")
